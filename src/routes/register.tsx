    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <select
          ...
          className="w-full rounded-lg border border-input bg-background px-4 py-2.5 text-sm outline-none transition-all focus:ring-2 focus:ring-ring"
        >
          <option value="UG Students — Registration Fee (₹ 1,000)">UG Students — Registration Fee (₹ 1,000)</option>
          <option value="PG Students — Registration Fee (₹ 1,250)">PG Students — Registration Fee (₹ 1,250)</option>
          <option value="UG Students — Publication Cost (₹ 10,450)">UG Students — Publication Cost (₹ 10,450)</option>
          <option value="PG Students — Publication Cost (₹ 13,500)">PG Students — Publication Cost (₹ 13,500)</option>
      ...
      <main className="mx-auto max-w-4xl px-4 py-20 sm:px-6">
                ...
                {FEES.map((f) => (
                  ...
                  >
                    ...
                    <div className="mt-1 flex items-center justify-between">
                      ...
                      <span className="font-bold text-primary">{f.cost}</span>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-3">
          <div className="rounded-xl border border-border bg-ice p-6">
            <h4 className="font-display font-bold text-navy">📅 Tentative Date</h4>
            <p className="mt-2 text-sm text-muted-foreground">18th December 2026</p>
          </div>
          <div className="rounded-xl border border-border bg-ice p-6">
